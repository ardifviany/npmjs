...
.btalxhddly button {
        background: url(https://cdn.statically.io/gh/AlexHostX/hdi/main/v5/balxtnt.png) no-repeat center;
...
.btntalxida button {
        background: url(https://cdn.statically.io/gh/AlexHostX/hdi/main/v5/balxtntk.png) no-repeat center;
    background-size: 100% 100%;
    border: none;
    outline: none;
    width: 100px;
